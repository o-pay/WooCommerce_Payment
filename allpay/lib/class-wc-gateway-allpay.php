...
class WC_Gateway_Allpay extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->icon = apply_filters('woocommerce_allpay_icon', plugins_url('images/icon.png', dirname( __FILE__ )));
    ...
    public function receipt_page($order_id)
    {
        ...
        try {
            ...
            $aio->Send['TradeDesc'] = 'OPay_module_woocommerce_1.1.1207';
